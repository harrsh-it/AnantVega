...
// import { AnantVegaFooter } from '../assets/icons'
// const Footer = () => {
//   return (
//     <div class="flex items-end w-full    bg-slate-200" > 
    
//         <footer class="w-full text-gray-700 bg-gray-100 body-font">
//             <div
//                 class="container flex flex-col flex-wrap  py-16 mx-auto md:items-center lg:items-start md:flex-row md:flex-no-wrap">
...
//                         <img 
//                         class="w-auto h-44 text-gray-900 fill-current  "
//                         src={AnantVegaFooter} alt="logo" />
